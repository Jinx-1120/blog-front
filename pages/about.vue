    ...
    <div class="info-box" :class="{'info-mobile': mobileLayout}">
      <div class="info ">
        <div class="list">
          ...
          <span class="list-content">五角六芒星, <span >a 90s boy.</span></span>
        </div>
        <div class="list">
          <i class="iconfont icon-zan"></i>
          <span class="list-content">Code, read, and onePiece.</span>
        </div>
        <div class="list">
        ...
        <div class="list">
          ...
          <span class="list-content icons">
            ...
            <a href="https://github.com/Jhaidi" target="_blank"><i class="iconfont icon-github"></i></a>
            <a href="https://juejin.im/user/58d0897d5c497d0057d1cb6a" target="_blank"><i class="iconfont icon-juejin"></i></a>
            <a href="https://www.weibo.com/5354973092/profile?rightmod=1&wvr=6&mod=personinfo" target="_blank"><i class="iconfont icon-weibo"></i></a>
            <!-- <a href="https://twitter.com/dNLKvo6WJMuASJ5" target="_blank"><i class="iconfont icon-twitter"></i></a> -->
            <!-- <a href="" target="_blank"><i class="iconfont icon-stackoverflow"></i></a> -->
            <!-- <a href="" target="_blank"><i class="iconfont icon-zhihu"></i></a> -->
            <a href="mailto:haidi_jin@163.com" target="_blank"><i class="iconfont icon-email"></i></a>
      ...
      <div class="user-box">
        <div class="user">
          <img src="../static/user.jpeg" alt="" width="100%">
        </div>
      </div>
    </div>
